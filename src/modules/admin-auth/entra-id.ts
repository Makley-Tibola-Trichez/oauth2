 ...
 * forma explícita em vez de aceitar credenciais sem verificação. O
 * `AdminAuthPlugin` traduz esse erro para `503`, não `401`: o problema é do
 * serviço, não de quem chamou.
 */

import { type AutenticadorAdmin, type IdentidadeAdmin, ORIGEM_ENTRA_ID } from './admin-auth.types';

export class AutenticadorEntraId implements AutenticadorAdmin {
